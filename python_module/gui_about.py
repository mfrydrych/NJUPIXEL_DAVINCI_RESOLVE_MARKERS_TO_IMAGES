...
class Ui_ABOUT_WINDOW(object):
    def setupUi(self, ABOUT_WINDOW):
        ...
        self.verticalSpacer_3 = QSpacerItem(
            20, 200, QSizePolicy.Minimum, QSizePolicy.Fixed
        )
        ...
        self.label_info_3.setAlignment(
    ...
    def retranslateUi(self, ABOUT_WINDOW):
        ...
        ABOUT_WINDOW.setToolTip(
            QCoreApplication.translate("ABOUT_WINDOW", "About", None)
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ABOUT_WINDOW.setStatusTip(
            QCoreApplication.translate("ABOUT_WINDOW", "About", None)
        )
        # endif // QT_CONFIG(statustip)
        # if QT_CONFIG(whatsthis)
        ABOUT_WINDOW.setWhatsThis(
            QCoreApplication.translate("ABOUT_WINDOW", "About", None)
        )
        ...
        self.label_info_2.setText(
            QCoreApplication.translate(
                "ABOUT_WINDOW",
                "This aplication allows you to export timeline markers as images file.\n"
        ...
        self.label.setText(
            QCoreApplication.translate("ABOUT_WINDOW", "njupixel@gmail.com", None)
        )
        self.label_info_3.setText(
            QCoreApplication.translate(
                "ABOUT_WINDOW", "Copyright \u00a9 2023 NJUPIXEL Maciej Frydrych", None
            )
        )
